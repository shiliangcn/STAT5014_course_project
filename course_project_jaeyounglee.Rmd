...
```
From the raw data, $12515164$ observations are used which *Re-tweet counts* are non-zero. To speed up computation, re-sampling methods, which is similar to Bootstrap, is used. From the result, we can build a logistic regression model as follows:
